...
public class DataEngineExpandoBridgeFactory implements ExpandoBridgeFactory {
	...
	public ExpandoBridge getExpandoBridge(long companyId, String className) {
		if (_dataEngineIntrinsicObjects.containsKey(className)) {
	...
	protected void setDataEngineIntrinsicObject(
		DataEngineIntrinsicObject dataEngineIntrinsicObject) {

		_dataEngineIntrinsicObjects.put(
			dataEngineIntrinsicObject.getClassName(),
			dataEngineIntrinsicObject.getClassName());
	}

	protected void unsetDataEngineIntrinsicObject(
		DataEngineIntrinsicObject dataEngineIntrinsicObject) {

		_dataEngineIntrinsicObjects.remove(
			dataEngineIntrinsicObject.getClassName());
	}

	private final Map<String, String> _dataEngineIntrinsicObjects =
