...
<div id="<%= appBuilderRootElementId %>">
	...
	data.put("includeForm", ParamUtil.getLong(request, AppBuilderWebKeys.INCLUDE_FORM));
	data.put("includeTable", ParamUtil.getLong(request, AppBuilderWebKeys.INCLUDE_TABLE));
