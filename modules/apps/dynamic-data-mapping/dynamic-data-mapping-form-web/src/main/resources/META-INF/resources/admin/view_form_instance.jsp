		...
		<c:choose>
			...
			<c:otherwise>
				<liferay-frontend:empty-result-message
					...
					description='<%= ddmFormAdminDisplaySearchContainer.isSearch() ? "" : LanguageUtil.get(request, "create-and-publish-a-form") %>'
					title='<%= ddmFormAdminDisplaySearchContainer.isSearch() ? LanguageUtil.get(request, "no-forms-were-found") : LanguageUtil.get(request, "there-are-no-forms") %>'
				/>
			</c:otherwise>
		</c:choose>
	</aui:form>
